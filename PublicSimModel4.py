...
class Agent:
    ...
    def calculate_tax(self, economy):
        ...
        tax_rate = economy.tax_algorithm(earning_rate)
...
def objective_function(params):
    economy = Economy(10, 100, 10, tax_algorithm(params))
    economy.simulate(1000)
...
# Create directories for winners and best winners
